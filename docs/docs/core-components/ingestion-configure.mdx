...
If you use different embedding models for different documents, you can creating [filters](/knowledge-filters) to separate documents that were embedded with different models.
